...
void proyecto3() {
    ...
    char respuesta;
    //inicio del proyecto
    printf("*Este programa sumara 5 unidades a numeros menores a 500, esto 100 veces; o 10 "
           "unidades si es mayor a 500 y menor a 1000, esto 50 veces; para posteriormente sumar todas las cantidades*\n");
        do { //ciclo do-while
